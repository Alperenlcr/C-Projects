...
void aciklama_yazdir(int problem_numarasi)
{
    ...
    case 2:
        ...
        printf("Degiskenler : secim yazdirma secenegi icin, x birer birer artan x degeri icin, min_x en kucuk goruntunun verildigi x degerini saklamak icin, max_x en buyuk goruntunun verildigi x degerini saklamak icin, deger denklemden gelen degeri tutmak icin, min en kucuk goruntu icin, max en buyuk goruntu icin var.\n\n");
        printf("Yontem : x degerleri -40,40 araliginda birer birer arttiriliyor dongu icinde. Her yeni degerde o zamana kadarki elde edilmis en kucuk ve en buyuk degerle kiyaslaniyor. Duruma gore degerler guncelleniyor. Denklem icin fonksiyon yazilmistir, ordan degerler donduruluyor.\n\n");
        printf("Ekran ciktisi : secime gore her x degerinin goruntusu yazdirilabiliyor. Max ve min degerlerini veren x degerleri ile beraber min ve max degerleri de yazdiriliyor.\n\n");
        break;

    case 3:
        printf("\n\nPROBLEM 3 icin Aciklamalar\n--------------------------\n");
        printf("Degiskenler : Matris girilen matrisi saklamak icin, toplam toplam hesaplarken ve yazdirmak icin, carpim carpim hesaplarken ve yazdirmak icin, boyut dongu sayisi icin var.\n\n");
        printf("Yontem : Iki kez matris eleman sayisi kadar dongulerde donuluyor. Ilkinde girdiler aliniyor matris olusturuluyor. Ikincide ise matris yazdiriliyor ve if kosullari ile hesaplamalar yaptiriliyor.\n\n");
        printf("Ekran ciktisi : Girilen matris yazdiriliyor. Sonrasinda hesaplanan degerler yazdiriliyor.\n\n");
        break;

    case 4:
        printf("\n\nPROBLEM 4 icin Aciklamalar\n--------------------------\n");
        printf("Degiskenler : ilk_defa adli bir degiskeni parametre olarak aliyor problemi cozen fonksiyon. kendi icinde input aliyor ve cozum yapiyor. denklem ve denklemin turevi fonksiyonlarini kullaniyor. istenilen_hata_miktari, x1_degeri, x1, hata_miktari, x0 degiskenleri var.\n\n");
        printf("Yontem : Newton-Rapshon yontemi ile problem cozume kavusturulmustur. Yontemin detaylarina burada yer vermiyorum cunku karmasik bir yontem.\n\n");
        printf("Ekran ciktisi : Kullanicidan alinan istege gore sonuca giderken her iterasyonda kullaniciya bilgi verilebilir. Tanimsizlik durumlarinda uyari verilir tekrar input istenir. Sonuc bulundugu iterasyon numarsi ile beraber yazdirilir.\n\n");
        break;

    case 5:
        printf("\n\nPROBLEM 5 icin Aciklamalar\n--------------------------\n");
        printf("Degiskenler : satis_miktari girilecek deger icin var, elliden_kucuk 1.5 ile carpilacak sayiyi sakliyor, elli_yuz 2.0 ile carpilacak sayiyi sakliyor, yuzden_buyuk 2.5 ile carpilacak sayiyi sakliyor.\n\n");
        printf("Yontem : Girilen degere gore if kosullari sayesinde degiskenlerimize dogru degerler ataniyor. Sonrasinda da carpilip yazdiriliyor.\n\n");
        printf("Ekran ciktisi : Girilen degere gore yapilan hesaplama bir cumlede anlatiliyor ve hesaplanan prim yazdiriliyor.\n\n");
        break;

    case 6:
        printf("\n\nGenel Aciklamalar\n--------------------------\n");
        printf("Kodun genelinde bir modullerlik hakim. Ana fonksiyonlardan alt fonksiyonlar cagirilarak ilerliyor kod. Programin isleyisi ile ilgili olan bu fonksiyonlar disinda, arabirimde kullanilmak uzere iki adet fonksiyon vardir. Bunlar ekran_temizleme ve bekletme fonksiyonlaridir.\n\n");
        break;
